...
const JournalPage = ({ location }) => (
  <Layout location={location}>
    ...
    <div className="year-section">
        <h2 className="year-title">2017</h2>
        ...
        <a href="/dergi/iktisadiyat_dergi_2017.pdf" className="download-link">İktisadiyat Dergi 2017 : İndirmek için tıklayınız.</a>
    </div>
    ...
    <div className="year-section">
        ...
        <a href="/dergi/iktisadiyat_dergi_2016.pdf" className="download-link">İktisadiyat Dergi 2016 : İndirmek için tıklayınız.</a>
    </div>
